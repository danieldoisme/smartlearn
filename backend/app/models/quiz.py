...
if TYPE_CHECKING:
    from backend.app.models.content import Chapter
...
class Question(Base):
    ...
    question_type: Mapped[QuestionType] = mapped_column(
        SAEnum(QuestionType, values_callable=_enum_values), nullable=False
    )
...
class StudySession(Base):
    ...
    session_type: Mapped[SessionType] = mapped_column(
        SAEnum(SessionType, values_callable=_enum_values), nullable=False
    )
